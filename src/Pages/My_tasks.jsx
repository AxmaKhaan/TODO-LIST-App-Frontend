...
export default function My_tasks() {
  ...
  const handleSubmit = async (e) => {
    ...
    let url = "https://todo-list-app-backend-production-622b.up.railway.app/mytask/addtask";
    let method = "POST";

    if (editId) {
      url = `https://todo-list-app-backend-production-622b.up.railway.app/mytask/editTask/${editId}`;
      method = "PUT";
    }
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const res = await fetch(`https://todo-list-app-backend-production-622b.up.railway.app/mytask/deletetask/${id}`, {
        method: "DELETE"
      });
