...
export default function My_tasks() {
  ...
  const handleSubmit = async (e) => {
    ...
    let url = "http://todo-list-app-backend-production-622b.up.railway.app/mytask/addtask";
    let method = "POST";

    if (editId) {
      url = `http://todo-list-app-backend-production-622b.up.railway.app/mytask/editTask/${editId}`;
      method = "PUT";
    }
  ...
  const fetchTasks = async () => {
    const res = await fetch("http://todo-list-app-backend-production-622b.up.railway.app/mytask/tasks");
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const res = await fetch(`http://todo-list-app-backend-production-622b.up.railway.app/mytask/deletetask/${id}`, {
        method: "DELETE"
      });
